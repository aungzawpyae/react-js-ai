  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-white">Auto Trading Agent</h2>
          <p className="mt-1 text-sm text-zinc-400">
            AI-powered automated trading on Binance Testnet - BTC, ETH, SOL with strict risk management
          </p>
        </div>
